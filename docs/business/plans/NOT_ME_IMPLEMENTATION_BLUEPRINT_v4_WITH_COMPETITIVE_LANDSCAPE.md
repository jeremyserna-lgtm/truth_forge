...
│  ├── Convert to Knowledge Atoms (per NOT_ME_CORE_SPEC §12)  │
...
│  ├── **Begin Genesis Protocol (biometric training)**        │
...
│  ├── Observable Personalization (document The Becoming)     │
│  ├── Freeze at 95% accuracy = Genesis v1.0                  │
│  └── DOC: Part I, Part III, /training/GENESIS_PROTOCOL.md   │
│                                                             │
...
| Document | Contains |
|----------|----------|
| `/docs/business/plans/NOT_ME_CORE_SPECIFICATION.md` | Technical spec (authoritative), Knowledge Atoms §12, Genesis Integration §13 |
| `/training/GENESIS_PROTOCOL.md` | Physiologically-verified training protocol, biometric hardware, The Becoming |
| `/docs/business/plans/FEDERATION_OPERATING_PLAN.md` | Inter-entity communication via Knowledge Atoms |
