...
class AutoSyncService:
    ...
    def __init__(
        ...
        self.service: TwentyCRMService | None = None
        self.error_reporter: ErrorReporter | None = None

        # Track last sync times per source for efficient polling
        self.last_bq_sync: datetime | None = None
        self.last_crm_sync: datetime | None = None
        self.last_supabase_sync: datetime | None = None
    ...
    def _sync_from_bigquery(self) -> int:
        ...
        """
        self._ensure_clients()
        if not self.service or not self.bq_client:
            return 0
        ...
        try:
            ...
            for contact in contacts:
                try:
                    ...
                    if crm_id is None:
                        continue
                    result = crm_sync.sync_from_crm_to_bigquery(str(crm_id))
    ...
    def get_stats(self) -> dict[str, Any]:
        ...
        return {
            ...
            "last_sync_time": self.stats.last_sync_time.isoformat()
