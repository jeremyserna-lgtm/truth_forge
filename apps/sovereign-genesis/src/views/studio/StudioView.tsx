/**
 * StudioView - Sovereign Studio (App Builder)
 *
 * Talk to Llama. Get working apps.
 * Chat-based app generation using local LLM.
 */

import React, { useState, useRef, useEffect } from 'react';
import { Send, Rocket, Loader2, Check, MessageSquare, Code } from 'lucide-react';
import { BuilderMessage, AppProject, BuildResult, StudioTab } from '../../types';
...
export const StudioView: React.FC = () => {
  ...
  const sendMessage = async () => {
    ...
    try {
      ...
      const assistantMessage: BuilderMessage = { role: 'assistant', content: assistantContent };
    ...
    <div className="h-full w-full flex flex-col bg-slate-900">
      ...
      <header className="bg-slate-800 border-b border-slate-700 px-6 py-4">
        <div className="flex items-center justify-between">
          <div>
            <h1 className="text-xl font-bold text-white">Sovereign Studio</h1>
      ...
      {/* Build Result Toast */}
      {buildResult?.success && (
        <div className="fixed bottom-6 right-6 bg-emerald-600 text-white px-6 py-4 rounded-lg shadow-lg z-50">
