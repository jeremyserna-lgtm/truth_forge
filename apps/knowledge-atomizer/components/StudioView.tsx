...
import { KnowledgeAtom, StudioArtifact, AudioLength, StudioFormat, DynamicStudioOption } from '../types';
...
import {
    ...
    ArrowDownTrayIcon, ClockIcon, BookOpenIcon,
    BeakerIcon, FolderArrowDownIcon, SpeakerWaveIcon
...
const StudioView: React.FC<StudioViewProps> = ({ atoms, isLoading, setLoading, onArtifactToAtoms, onArtifactToDocument }) => {
    const [_artifacts, setArtifacts] = useState<StudioArtifact[]>([]);
