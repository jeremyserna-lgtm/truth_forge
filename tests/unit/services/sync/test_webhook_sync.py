...
class TestWebhookSyncHandler:
    ...
    def test_init(
        ...
        """Test initialization."""
        with (
            patch("truth_forge.services.sync.webhook_sync.bigquery.Client") as mock_bq_client_class,
    ...
    def test_handle_crm_webhook_created(
        ...
        with (
            ...
            patch("truth_forge.services.sync.webhook_sync.TwentyCRMService") as mock_service_class,
            patch(
                "truth_forge.services.sync.webhook_sync.CRMTwentySyncService"
    ...
    def test_handle_supabase_webhook_insert(
        ...
        with (
            ...
            patch("truth_forge.services.sync.webhook_sync.TwentyCRMService") as mock_service_class,
            patch(
                "truth_forge.services.sync.webhook_sync.SupabaseSyncService"
