...
class TestAutoSyncService:
    ...
    def test_ensure_clients(
        ...
        with (
            patch(
                "truth_forge.services.sync.auto_sync_service.bigquery.Client"
            ) as mock_bq_client_class,
            patch(
                "truth_forge.services.sync.auto_sync_service.TwentyCRMService"
            ) as mock_service_class,
            patch(
                "truth_forge.services.sync.auto_sync_service.ErrorReporter"
    ...
    def test_sync_from_crm_success(
        ...
        with (
            ...
            patch(
                "truth_forge.services.sync.auto_sync_service.CRMTwentySyncService"
    ...
    def test_sync_from_supabase_success(
        ...
        with (
            ...
            patch(
                "truth_forge.services.sync.auto_sync_service.SupabaseSyncService"
