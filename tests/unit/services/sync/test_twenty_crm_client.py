...
class TestTwentyCRMClient:
    ...
    def test_init_with_secret_service(self, mock_secret_service: Mock, mock_settings: None) -> None:
    ...
    def test_get_api_key_mock_value(
        ...
        with patch("truth_forge.services.sync.twenty_crm_client.logger"):
            client = TwentyCRMClient(secret_service=mock_secret_service)
    ...
    def test_list_contacts_success(
        ...
        mock_response = create_mock_response(json_data={"people": [{"id": "crm_123"}]})
        mock_requests["get"].return_value = mock_response
    ...
    def test_list_contacts_dict_response(
        ...
        mock_response = create_mock_response(json_data={"data": [{"id": "crm_123"}]})
        mock_requests["get"].return_value = mock_response
    ...
    def test_upsert_contact_existing(
        ...
        list_response = create_mock_response(
            json_data={"people": [{"id": "crm_123", "customFields": {"contact_id": "bq_123"}}]}
        )
        ...
        get_response = create_mock_response(raise_error=requests.exceptions.HTTPError("404"))
    ...
    def test_update_contact_identifiers(
        ...
        client = TwentyCRMClient(secret_service=mock_secret_service)
        client._update_contact_identifiers(
            "crm_123", email="test@example.com", phone="+15551234567"
        )
    ...
    def test_update_contact_identifiers_error(
        ...
        update_response = create_mock_response(raise_error=Exception("Update failed"))
        mock_requests["patch"].return_value = update_response
    ...
    def test_list_companies_success(
        ...
        mock_response = create_mock_response(json_data={"data": [{"id": "company_123"}]})
        mock_requests["get"].return_value = mock_response
    ...
    def test_upsert_company_existing(
        ...
        get_response = create_mock_response(raise_error=requests.exceptions.HTTPError("404"))
        list_response = create_mock_response(
            json_data={"data": [{"id": "company_123", "customFields": {"business_id": "biz_123"}}]}
        )
    ...
    def test_create_custom_field_success(
        ...
        mock_response = create_mock_response(json_data={"id": "field_new_123", "name": "new_field"})
        mock_requests["post"].return_value = mock_response
    ...
    def test_get_person_relationships(
        ...
        mock_response = create_mock_response(json_data={"data": [{"id": "rel_1"}, {"id": "rel_2"}]})
        mock_requests["get"].return_value = mock_response
    ...
    def test_context_manager(self, mock_secret_service: Mock, mock_settings: None) -> None:
    ...
    def test_upsert_contact_with_email_phone_update(
        ...
        update_response = create_mock_response(json_data={"id": "crm_existing", "name": "Updated"})
