...
class TestTwentyCRMService:
    ...
    def test_init_with_all_clients(
        ...
        with (
            patch(
                "truth_forge.services.sync.twenty_crm_service.TwentyCRMClient"
            ) as mock_crm_client_class,
            patch(
                "truth_forge.services.sync.twenty_crm_service.ErrorReporter"
            ) as mock_error_reporter_class,
            patch(
                "truth_forge.services.sync.twenty_crm_service.BigQuerySyncService"
            ) as mock_bq_sync_class,
            patch(
                "truth_forge.services.sync.twenty_crm_service.BusinessSyncService"
            ) as mock_business_sync_class,
            patch("truth_forge.services.sync.twenty_crm_service.PeopleRelationshipSyncService"),
            patch("truth_forge.services.sync.twenty_crm_service.RelationshipSyncService"),
        ):
    ...
    def test_init_without_clients(
        ...
        with (
            ...
            patch(
                "truth_forge.services.sync.twenty_crm_service.bigquery.Client"
            ) as mock_bq_client_class,
            patch(
                "truth_forge.services.sync.twenty_crm_service.ErrorReporter"
            ) as mock_error_reporter_class,
            patch("truth_forge.services.sync.twenty_crm_service.BigQuerySyncService"),
            patch("truth_forge.services.sync.twenty_crm_service.BusinessSyncService"),
            patch("truth_forge.services.sync.twenty_crm_service.PeopleRelationshipSyncService"),
            patch("truth_forge.services.sync.twenty_crm_service.RelationshipSyncService"),
        ):
            mock_crm_client = Mock()
    ...
    def test_sync_contact_from_crm(
        ...
        with (
            ...
            patch("truth_forge.services.sync.twenty_crm_service.RelationshipSyncService"),
            patch(
                "truth_forge.services.sync.crm_twenty_sync.CRMTwentySyncService"
            ) as mock_crm_sync_class,
        ):
            mock_crm_client = Mock()
            mock_crm_client_class.return_value = mock_crm_client
