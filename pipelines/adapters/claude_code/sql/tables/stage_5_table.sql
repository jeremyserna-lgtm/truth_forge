-- Stage 5 Table: claude_code_stage_5
-- Purpose: Store ready messages for NLP processing
-- Pattern: Universal Pipeline Pattern - Stage 5 (Ready Messages)

CREATE TABLE IF NOT EXISTS `flash-clover-464719-g1.spine.claude_code_stage_5` (
  -- Entity Identifiers
...
ALTER TABLE `flash-clover-464719-g1.spine.claude_code_stage_5`
SET OPTIONS (
  labels=[
