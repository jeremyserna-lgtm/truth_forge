#!/usr/bin/env python3
"""Run the complete claude_code pipeline from Stage 0 through Stage 5.
...
try:
    ...
    from src.services.central_services.core import get_logger as _get_logger
_LOGGER = _get_logger(__name__)
script_id = "pipelines.claude_code.scripts.utilities.run_full_pipeline.py"
...
STAGE_0 = PROJECT_ROOT / "pipelines" / "claude_code" / "scripts" / "stage_0" / "claude_code_stage_0.py"
STAGE_1 = PROJECT_ROOT / "pipelines" / "claude_code" / "scripts" / "stage_1" / "claude_code_stage_1.py"
STAGE_3 = PROJECT_ROOT / "pipelines" / "claude_code" / "scripts" / "stage_3" / "claude_code_stage_3.py"
STAGE_4 = PROJECT_ROOT / "pipelines" / "claude_code" / "scripts" / "stage_4" / "claude_code_stage_4.py"
STAGE_6 = PROJECT_ROOT / "pipelines" / "claude_code" / "scripts" / "stage_6" / "claude_code_stage_6.py"
